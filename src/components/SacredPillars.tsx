        ...
        <div className="grid md:grid-cols-3 gap-8 lg:gap-12">
          {pillars.map((pillar, index) => (
            ...
            >
              ...
              {/* Bottom accent line */}
              <div className="mt-8 w-16 h-px bg-gradient-to-r from-transparent via-gold/50 to-transparent mx-auto opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
            </div>
          ))}
        </div>
      </div>
